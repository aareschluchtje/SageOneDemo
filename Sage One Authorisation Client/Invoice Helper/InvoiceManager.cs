    ...
    public class InvoiceManager
    {
        ...
        public string CreateInvoice(string invoiceName, PaymentStatus paymentStatus, string reference, string contactid, string date, string token)
        {
            ...
            List<KeyValuePair<string, string>> postData = new List<KeyValuePair<string, string>> {
                      ...
                      new KeyValuePair<string,string>("sales_invoice[line_items_attributes][0][description]","HardwareTestCode"),
                      ...
                      new KeyValuePair<string,string>("sales_invoice[line_items_attributes][0][discount_percentage]","20")
            };
